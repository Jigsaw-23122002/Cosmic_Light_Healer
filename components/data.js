...
const benefitTwo = {
  title: "Yogi Vinu",
  desc: "A Yogi and a Warrior. Being of a very different and high energy intensity at young age, he was drawn towards Martial arts, Thai chi and Yoga. This made him experience the importance of mind, body and soul alignment through continuous practices of 22 years. He further accomplished the master’s degree in Yoga but it did not satisfied his quest for answers. While surfing through the hard waves of life he was turned inward. He became an ardent spiritual seeker. As he says by the blessings of divine mother and masters, he walked through different paths being blessed and accepted by masters of different traditions. He experienced the real essence of these paths inside himself through initiations into secret practices. On the physical dimension wisdom of many lineages and masters operate through him. He channelizes the energy of cosmos through the healings, meditations and spiritual teachings.",
  image: benefitTwoImg,
  bullets: [
    {
